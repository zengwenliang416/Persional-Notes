...
- [3.1 文件暂存方式选择](#文件暂存方式选择)

- [3.2 规范化的提交信息](#规范化的提交信息)

- [3.3 自定义提交格式](#自定义提交格式)

- [3.4 错误处理和状态跟踪](#错误处理和状态跟踪)
...
- [7.1 Windows 系统配置](#windows-系统配置)

- [7.2 macOS/Linux 系统配置](#macoslinux-系统配置)
...
- [10.1 中文路径显示问题](#中文路径显示问题)

- [10.2 终端输入处理优化](#终端输入处理优化)

- [10.3 Shell 兼容性问题](#shell-兼容性问题)

[11. 注意事项](#注意事项-1)

[12. 常见问题](#常见问题)

- [12.1 Q1: 为什么选择交互式添加文件？](#q1-为什么选择交互式添加文件)

- [12.2 Q2: 提交失败后如何处理？](#q2-提交失败后如何处理)

- [12.3 Q3: 如何修改默认的提交类型？](#q3-如何修改默认的提交类型)

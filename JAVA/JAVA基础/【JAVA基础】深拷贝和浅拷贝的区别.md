...
- [4. 代码示例](#代码示例)
    - [使用`clone()`方法实现深拷贝](#使用clone方法实现深拷贝)
    - [使用构造器实现深拷贝](#使用构造器实现深拷贝)
    - [使用序列化和反序列化实现深拷贝](#使用序列化和反序列化实现深拷贝)
    - [使用第三方库实现深拷贝（如Apache Commons Lang的SerializationUtils）](#使用第三方库实现深拷贝如apache-commons-lang的serializationutils)
    - [拷贝工厂的优缺点](#拷贝工厂的优缺点)
